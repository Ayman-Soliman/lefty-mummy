...
<div class="page-content flex-1 overflow">
    ...
    <h1 class="m-20 relative fit-content">All Products</h1>
        <?php 
                    ...
                    <table class="auto mt-20">
                        <thead class="bold">
                            <tr>
                                ...
                                <td class="p-20 bg-grey" >Parent Cat</td>
                                <td class="p-20 bg-grey" >Sub Cat</td>
                                <td class="p-20 bg-grey" >Original Price</td>
                                <td class="p-20 bg-grey" >Disc</td>
                                <td class="p-20 bg-grey" >After Disc</td>
                        ...
                        if (mysqli_num_rows($products)>0) {
                            ...
                            ?>
                                ...
                                <?php
                                    ...
                                    <td class="p-20 border-bottom" ><a href="../product.php?prod_id=<?=$product['id']?>&slug=<?=$product['prod_slug']?>">
                                    ...
                                    <td class="p-20 border-bottom" ><?=date('jS M, Y',strtotime($product['created_at']))?></td>
