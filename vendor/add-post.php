...
<div class="page-content flex-1 overflow">
    ...
    <h1 class="m-20 relative fit-content">Add Post</h1>
        <?php 
    ...
    <div class="wrapper  p-10">
        <div class="quick-draft bg-white p-20 txt-c-mobile rad-10 relative">
            ...
            <form class="mt-20 txt-c-mobile" action="functions/code.php" method="POST" enctype="multipart/form-data">
                ...
                <input class="bg-grey block mb-5 w-full border-grey rad-6 p-10" type="text" name="title" placeholder="Post Title" required>
                
                <label class="block mb-2 bold c-main" for="">Post Slug</label>
                <input class="bg-grey block mb-5 w-full border-grey rad-6 p-10" type="text" name="slug" placeholder="Post Slug" required>
                <div>
                    ...
                    <input class="bg-grey mb-3 w-full border-grey rad-6 p-10 hide" id="post_cover" name="post_cover" type="file" required onchange="view(this,'preview');">
                    <div class="c-red txt-c disc" id="preview_prod_error"></div>
                </div>
                <label class="block mb-2 bold c-main" for="">Post Sammary</label>
                <textarea class="bg-grey w-full border-grey rad-6 p-10 mb-20" name="sammary" placeholder="Post Sammary"></textarea>
                ...
                <textarea class="content bg-grey w-full border-grey rad-6 p-10 mb-20" name="content" placeholder="Post Content"></textarea>
                ...
                <div class="flex fit-content left-auto gap-20">
                    <a class="btn btn-danger rad-6 p-2 m-2 " href="all-categories.php" >Cancel</a>
                    <button class="btn btn-primary rad-6 p-2 m-2" type="submit" name="add-post-btn" >Add Post</button>
                </div>
            </form>
        </div>
    </div>
