        ...
        switch ($scope) {
            case 'add':
                ...
                if (mysqli_num_rows($check_existing_run)>0) {
                    ...
                    $add_to_cart_query = "INSERT INTO carts (prod_id, user_id) VALUES ('$prod_id','$user_id')";
            ...
            case 'delete':
                ...
                $check_existing_run = mysqli_query($con,$check_existing);
                if (mysqli_num_rows($check_existing_run)>0) {
                    $delete_cart_item = "DELETE FROM carts WHERE prod_id='$prod_id' AND user_id='$user_id'";
                    $delete_cart_item_run = mysqli_query($con, $delete_cart_item);
                    if ($delete_cart_item_run) {
                        # code...
                        // echo 'deleted';
                        echo 201;
                    }else {
