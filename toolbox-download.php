...
<body>
    ...
    <!-- <section id="hire-me" class="pad-top">
        <div class="container">
            <p>Send me the toolbox design on this E-Mail</p>
            <div class="contact-form card">
                ...
                <form id="contact-form" method="POST" action="request-design-form-handler.php">
                    ...
                    <input type="hidden" class="form-control" type="text" name="design-name" id="" placeholder="toolbox" value="toolbox" ></input><br>
    ...
    <?php
        if (isset ($_GET['name'])) {
            if ($_GET['name'] == 'tool-box') {
    ?>
                # code...
                <div class="download-div">
                    <a href="/downloads/tool box like.dxf" download rel="noopener noreferrer nofollow" target="_blank">Download design.</a>
