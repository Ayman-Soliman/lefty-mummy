...
<body>
    ...
    <!-- <section id="hire-me" class="pad-top">
        <div class="container">
            <p>Send me the small-numbers design on this E-Mail</p>
            <div class="contact-form card">
                ...
                <form id="contact-form" method="POST" action="request-design-form-handler.php">
                    ...
                    <input type="hidden" class="form-control" type="text" name="design-name" id="" placeholder="small-numbers" value="small-numbers" ></input><br>
    ...
    <?php
        if (isset ($_GET['name'])) {
            if ($_GET['name'] == 'small-numbers') {
    ?>
                # code...
                <div class="download-div">
                    <a href="/downloads/allnumbersboxes25cmx18.75cmx5cm.zip" download rel="noopener noreferrer nofollow" target="_blank">Download design.</a>
