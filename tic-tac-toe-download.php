    ...
    <nav>
        <div class="logo">
            ...
            <!-- <section id="hire-me" class="pad-top">
                <div class="container">
                    <p>Send me the tic-tac-toe design on this E-Mail</p>
                    ...
                    <input type="hidden" class="form-control" type="text" name="design-name" id="" placeholder="tic-tac-toe" value="tic-tac-toe" ></input><br>
                    ...
                    <?php
                        if (isset ($_GET['name'])) {
                            if ($_GET['name'] == 'tic-tac') {
                    ?>
                                # code...
                                <div class="download-div">
                                    <a href="/downloads/TicTacToe.rar" download rel="noopener noreferrer nofollow" target="_blank">Download design.</a>
