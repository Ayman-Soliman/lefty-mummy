...
<head>
    ...
    <title>all alphabets with Heart</title>
...
<body>
    ...
    <!-- <section id="hire-me" class="pad-top">
        <div class="container">
            <p>Send me the all-alphabets-with-Heart design on this E-Mail</p>
            <div class="contact-form card">
                ...
                <form id="contact-form" method="POST" action="request-design-form-handler.php">
                    ...
                    <input type="hidden" class="form-control" type="text" name="design-name" id="" placeholder="all-alphabets-with-Heart" value="all-alphabets-with-Heart" ></input><br>
    ...
    <?php
        if (isset ($_GET['name'])) {
            if ($_GET['name'] == 'alphabet-heart') {
    ?>
                # code...
                <div class="download-div">
                    <a href="/downloads/all alphabet with heart designs.zip" download rel="noopener noreferrer nofollow" target="_blank">Download design.</a>
