...
<head>
    ...
    <title>great bulk designs</title>
...
<body>
    ...
    <!-- <section id="hire-me" class="pad-top">
        <div class="container">
            <p>Send me the great-bulk design on this E-Mail</p>
            <div class="contact-form card">
                ...
                <form id="contact-form" method="POST" action="request-design-form-handler.php">
                    ...
                    <input type="hidden" class="form-control" type="text" name="design-name" id="" placeholder="great-bulk" value="great-bulk" ></input><br>
    ...
    <?php
        if (isset ($_GET['name'])) {
            if ($_GET['name'] == 'great-bulk') {
    ?>
                # code...
                <div class="download-div">
                    <a href="/downloads/Great Bulk Designs.rar" download rel="noopener noreferrer nofollow" target="_blank">Download design.</a>
