...
<head>
    ...
    <title>fathers day bundle</title>
...
<body>
    ...
    <!-- <section id="hire-me" class="pad-top">
        <div class="container">
            <p>Send me the father's-day-bundle design on this E-Mail</p>
            <div class="contact-form card">
                ...
                <form id="contact-form" method="POST" action="request-design-form-handler.php">
                    ...
                    <input type="hidden" class="form-control" type="text" name="design-name" id="" placeholder="fathers-day" value="fathers-day" ></input><br>
    ...
    <?php
        if (isset ($_GET['name'])) {
            if ($_GET['name'] == 'fathers-day') {
    ?>
                # code...
                <div class="download-div">
                    <a href="/downloads/Fathersdaybundle.rar" download rel="noopener noreferrer nofollow" target="_blank">Download design.</a>
