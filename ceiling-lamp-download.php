...
<body>
    ...
    <!-- <section id="hire-me" class="pad-top">
        <div class="container">
            <p>Send me the ceiling Lamp design on this E-Mail</p>
            <div class="contact-form card">
                ...
                <form id="contact-form" method="POST" action="request-design-form-handler.php">
                    ...
                    <input type="hidden" class="form-control" type="text" name="design-name" id="" placeholder="ceiling-lamp" value="ceiling-lamp" ></input><br>
    ...
    <?php
        if (isset ($_GET['name'])) {
            if ($_GET['name'] == 'ceiling-lamp') {
    ?>
                # code...
                <div class="download-div">
                    <a href="/downloads/celling lamp with Islamic pattern 60X60cm.rar" download rel="noopener noreferrer nofollow" target="_blank">Download design.</a>
