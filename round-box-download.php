...
<head>
    ...
    <title>two drawers round box</title>
...
<body>
    ...
    <!-- <section id="hire-me" class="pad-top">
        <div class="container">
            <p>Send me the round-box design on this E-Mail</p>
            <div class="contact-form card">
                ...
                <form id="contact-form" method="POST" action="request-design-form-handler.php">
                    ...
                    <input type="hidden" class="form-control" type="text" name="design-name" id="" placeholder="round-box" value="round-box" ></input><br>
    ...
    <?php
        if (isset ($_GET['name'])) {
            if ($_GET['name'] == 'round-box') {
    ?>
                # code...
                <div class="download-div">
                    <a href="/downloads/Two Drawers Round Gift Box.rar" download rel="noopener noreferrer nofollow" target="_blank">Download design.</a>
