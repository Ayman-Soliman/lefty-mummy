...
<body>
    ...
    <!-- <section id="hire-me" class="pad-top">
        <div class="container">
            <p>Send me the graduation-cap design on this E-Mail</p>
            <div class="contact-form card">
                ...
                <form id="contact-form" method="POST" action="request-design-form-handler.php">
                    ...
                    <input type="hidden" class="form-control" type="text" name="design-name" id="" placeholder="graduation-cap" value="graduation-cap" ></input><br>
    ...
    <?php
        if (isset ($_GET['name'])) {
            if ($_GET['name'] == 'graduation-cap') {
    ?>
                # code...
                <div class="download-div">
                    <a href="/downloads/GraduationHatBox.rar" download rel="noopener noreferrer nofollow" target="_blank">Download design.</a>
